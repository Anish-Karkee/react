  ...
  <div className="grid gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
    <div className="sm:col-span-2">
      <a href="/" aria-label="Go home" title="Company" className="inline-flex items-center">
        ...
        <span className="ml-2 text-xl font-bold tracking-wide text-gray-800 uppercase">Young Enfeilders</span>
      </a>
    ...
    <div className="space-y-2 text-sm">
      ...
      <div className="flex">
        ...
        <a href="tel:850-123-5021" aria-label="Our phone" title="Our phone" className="transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800">9802346502</a>
      </div>
      <div className="flex">
        <p className="mr-1 text-gray-800">Email:</p>
        <a href="mailto:info@lorem.mail" aria-label="Our email" title="Our email" className="transition-colors duration-300 text-deep-purple-accent-400 hover:text-deep-purple-800">youngenfielders4@gmail.com</a>
      </div>
      <div className="flex">
    ...
    <div>
      ...
      <p className="mt-4 text-sm text-gray-500">
         Young Enfielders is a passionate Royal Enfield riders’ community based in the eastern region of Nepal, united by the love for classic machines, brotherhood, and the open road.
      </p>
    </div>
  </div>
