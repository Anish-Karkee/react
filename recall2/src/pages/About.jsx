  ...
  <div className="w-full h-full flex flex-col justify-center items-center sm:px-4 px-2">
    ...
    <div className="lg:w-[90%] w-full mx-auto flex flex-col lg:gap-6 lg:flex-row items-center justify-center ">
      ...
      <div className="lg:w-[60%] p-4 w-full h-full  flex flex-col justify-center items-centre sm:px-6 px-4 rounded-xl">
        ...
        {/* button */}
        <Link to="/product"><Button text="Products" color="text-white bg-black hover:text-black hover:scale-105 hover:shadow-lg transition duration-300 mt-10"/></Link>
      </div>
    </div>
  </div>
</div>
...
<div className="w-full lg:h-screen h-full m-auto flex items-center justify-center py-20 bg-white">
  <div className="w-full h-full flex flex-col justify-center items-center sm:px-4 px-2">
    ...
    <div className="lg:w-[90%] w-full mx-auto flex flex-col lg:gap-6 lg:flex-row items-center justify-center">
      ...
      <div className="relative">
        <img
          className="rounded-full object-cover lg:w-120 lg:h-120 sm:w-100 sm:h-100 w-48 h-48 shadow-lg"
          src={me}
          alt="About the store"
        />
      </div>
      ...
      <div className="lg:w-[60%] p-4 w-full h-full flex flex-col justify-center items-center sm:px-6 px-4 rounded-xl">
        ...
        <p className="md:text-xl sm:text-lg text-base mt-4 text-justify sm:px-2 dark:text-black">
          ...
          The website focuses on intuitive navigation, fast loading performance, and mobile-first design, making it suitable for all devices. 
          It highlights essential e-commerce functionalities such as product filtering, search options, pricing display, and order summary, providing a realistic simulation of a real-world online store.
          This project is built as a demonstration of front-end and back-end integration concepts, UI/UX design principles, and modern web development practices. 
          It is intended for learning, testing, and portfolio purposes only and does not process real payments or orders.
        </p>
      </div>
